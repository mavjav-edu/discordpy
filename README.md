...
5. Get an oauth token from Discord (it will be the 'secret' for `writeToken.py`)
   ...
   5. Click 'Copy' under 'TOKEN' <object data="copyToken.svg" type="image/svg+xml" alt="Copy the token" height="20vh" align="initial"><img src="copyToken" alt="Copy the token" height="20vh" align="initial"></object>
...
7. Go to the OAuth2 tab <object data="oauthTab.svg" type="image/svg+xml" alt="OAuth2 tab" height="20vh" align="initial"><img src="oauthTab" alt="OAuth2 tab" height="20vh" align="initial"></object>
