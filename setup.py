...
setup(
    ...
    url='https://github.com/mavaddat-javid-education/discordpy',  # Optional

    # This should be your name or the name of the organization which owns the
    # project.
    author='Mavaddat Javid',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='javid@mavaddat.ca',  # Optional
    ...
    keywords='discord bot discordpy',  # Optional
